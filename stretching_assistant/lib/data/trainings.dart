...
final List<Training> presetTrainings = [
  Training(
    ...
    exercises: [
      ...
      MapEntry("Sissy Kozak Squat R", DurationHive(duration: 60)),
      MapEntry("Sissy Kozak Squat L", DurationHive(duration: 60)),
      MapEntry("Supported Backbend Stretch", DurationHive(duration: 60)),
      MapEntry("Runner Lunge R", DurationHive(duration: 60)),
      MapEntry("Runner Lunge L", DurationHive(duration: 60)),
      MapEntry("Horse Stance", DurationHive(duration: 60)),
      MapEntry("Straddle Head to Toe L", DurationHive(duration: 60)),
      MapEntry("Straddle Head to Toe R", DurationHive(duration: 60)),
      MapEntry("Pancake Stretch", DurationHive(duration: 60)),
      MapEntry("Butterfly Pancake Stretch", DurationHive(duration: 60)),
      MapEntry("Butterfly Stretch", DurationHive(duration: 60)),
      MapEntry("Head to Knee R", DurationHive(duration: 60)),
      MapEntry("Head to Knee L", DurationHive(duration: 60)),
      MapEntry("Crossed Leg Head to Knee R", DurationHive(duration: 60)),
      MapEntry("Crossed Leg Head to Knee L", DurationHive(duration: 60)),
      MapEntry("Seated Side Bend L", DurationHive(duration: 60)),
      MapEntry("Seated Side Bend R", DurationHive(duration: 60)),
      MapEntry("Half Seated Side Bend L", DurationHive(duration: 60)),
      MapEntry("Half Seated Side Bend R", DurationHive(duration: 60)),
      MapEntry("Seated Spinal Twist R", DurationHive(duration: 60)),
      MapEntry("Seated Spinal Twist L", DurationHive(duration: 60)),
      MapEntry("Flipped Forward Fold", DurationHive(duration: 60)),
      ...
      MapEntry("Lunge Backbend Stretch L", DurationHive(duration: 60)),
      MapEntry("Lunge Backbend Stretch R", DurationHive(duration: 60)),
      MapEntry("Bridge", DurationHive(duration: 60)),
      MapEntry("Bow Pose", DurationHive(duration: 60)),
      MapEntry("Seated Quad Stretch", DurationHive(duration: 60)),
      MapEntry("Horse Stance", DurationHive(duration: 60)),
      MapEntry("Kozak Squat Lean L", DurationHive(duration: 60)),
      MapEntry("Kozak Squat Lean R", DurationHive(duration: 60)),
      MapEntry("Half Side Split L", DurationHive(duration: 60)),
      MapEntry("Half Side Split R", DurationHive(duration: 60)),
      MapEntry("Half Side Split Lean L", DurationHive(duration: 60)),
      MapEntry("Half Side Split Lean R", DurationHive(duration: 60)),
      MapEntry("Side Split L", DurationHive(duration: 60)),
      MapEntry("Side Split R", DurationHive(duration: 60)),
      MapEntry("Middle Split", DurationHive(duration: 60)),
      MapEntry("Knee to Chest R", DurationHive(duration: 60)),
      MapEntry("Knee to Chest L", DurationHive(duration: 60)),
      MapEntry("Straight Leg Stretch R", DurationHive(duration: 60)),
      MapEntry("Straight Leg Stretch L", DurationHive(duration: 60)),
      MapEntry("Seated Foot to Head R", DurationHive(duration: 60)),
      MapEntry("Seated Foot to Head L", DurationHive(duration: 60)),
      MapEntry("Standing Foot to Head R", DurationHive(duration: 60)),
      MapEntry("Standing Foot to Head L", DurationHive(duration: 60)),
    ],
  ),
  Training(
    name: "Hip Opener",
